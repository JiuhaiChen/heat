...
dlmwrite('advection-dispersion2.txt',error);
dlmwrite('advection-dispersion2.txt',error_l0,'-append');
dlmwrite('advection-dispersion2.txt',sample,'-append');

dlmwrite('advection-dispersion2.txt',mean(error));
dlmwrite('advection-dispersion2.txt',std(error),'-append');
dlmwrite('advection-dispersion2.txt',mean(error_l0),'-append');
dlmwrite('advection-dispersion2.txt',std(error_l0),'-append');
dlmwrite('advection-dispersion2.txt',mean(sample),'-append');
dlmwrite('advection-dispersion2.txt',std(sample),'-append');
